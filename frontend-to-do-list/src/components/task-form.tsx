...
//     }
//     createComp?create(data):update('1', data);
//     setTitle('');
//     setDescription('');
//     setTerm(null);
//   };
...
//         <label htmlFor="description" className="text-gray-700 mb-2 text-black">
//           Descrição:
//         </label>
//         <textarea
//           id="description"
...
const TaskForm: React.FC<TaskFormProps> = ({ task }) => {
  ...
  const handleSubmitEdited = async (e: React.FormEvent) => {
    ...
    // Enviar os dados para create ou update
    const data = {
      title,
      description,
      term,
    ...
    try {
      createComp ? await create(data) : await update('1', data);
